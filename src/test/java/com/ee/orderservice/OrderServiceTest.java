...
public class OrderServiceTest {
	...
	public RequestResponsePact createPact(PactDslWithProvider builder) {
		...
		// TODO - This will get translated into the contract between order service and
		// user service.
		return builder.given("User Paresh exists").uponReceiving("user GET request").path("/user/" + USER_ID)
				.method("GET").willRespondWith().status(200).body(newJsonBody((a) -> {
